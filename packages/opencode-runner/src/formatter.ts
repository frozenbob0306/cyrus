...
/**
 * OpenCode formatter for tool activity messages in Linear.
 * Formats OpenCode tool calls into human-readable activity content.
 */
export class OpenCodeMessageFormatter implements IMessageFormatter {
	...
	formatToolParameter(toolName: string, toolInput: unknown): string {
		...
		// OpenCode tool: bash / shell command
